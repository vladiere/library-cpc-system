<template>
  <div class="q-pl-md row text-capitalize text-grey-10">
    <span class="text-h5 text-bold">Staffs Management</span>
  </div>
  ...
  <div class="q-pa-md">
    <q-table :rows="rows" row-key="name" flat bordered color="grey-5" />
  </div>
</template>
