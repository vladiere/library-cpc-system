<template>
  <div class="column q-gutter-y-md">
    ...
    <div class="column q-px-lg q-pt-xs q-pb-lg q-gutter-y-md">
      <span class="text-h6 text-grey-10">Create My List</span>
      <q-input dense square outlined color="grey-10" label="List Name" />
      <q-input
        dense
        outlined
        square
      ...
      <span class="text-subtitle1 text-grey-9"
        >Books available in your collection</span
      >
      <q-scroll-area
        :thumb-style="thumbStyle"
        :bar-style="barStyle"
        style="height: 32vh; max-width: 100%"
      >
        <div class="row items-center content-center q-ml-md">
          <q-img
          ...
          >
            <div class="absolute-bottom text-subtitle1 text-center column">
              {{ image.title }}
              <q-btn
                flat
                dense
                ...
                icon="add"
              >
                <q-tooltip class="bg-teal-5 text-grey-10"
                  >Add to list</q-tooltip
                >
              </q-btn>
            </div>
          </q-img>
      ...
      <div class="row">
        <q-btn
          ...
          color="blue-grey-5"
          size="md"
          class="text-subtitle1 text-grey-10 q-px-md"
        />
      </div>
    </div>
  </div>
