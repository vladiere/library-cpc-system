<template>
  <div class="q-px-xl q-mt-md">
    <span :class="$q.platform.is.mobile ? 'text-h6 q-mb-md' : 'text-h5 q-mb-md'" style="text-decoration: underline">More by this Author</span>
    <div v-if="recommendBooks.length === 0" class="column content-center items-center q-mt-md">
      <q-img :src="ManEmpty" style="width: 15rem;"/>
        <span class="text-grey-9 text-h6">Nothing by this Author</span>
    </div>
    <q-carousel
      v-else
      v-model="activeIndex"
